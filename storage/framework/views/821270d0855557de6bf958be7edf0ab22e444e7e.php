...
<?php if(Auth::check()): ?>
				...
				<a class="title nav-link float_right" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
...
<!--  -->
		...
		<div class="col-12">
			<div class="justify-content-center navig row">
				...
				<nav class="nav blog-nav">
					<img src="/uploads/avatars/<?php echo e($user->avatar); ?>" style="width: 30px; height: 30px; float: left; border-radius: 5px; margin: 2px;">
